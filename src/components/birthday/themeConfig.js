/**
 * Re-exports the central theme config from lib/themeConfig.
 * All birthday components that do import from './themeConfig' continue working.
 */
export { default } from '@/lib/themeConfig';

const _KEEP_UNUSED_BLOCK_START = {
  cute: {
...
// The real export is the re-export above. This block is never used.
const _UNUSED = _KEEP_UNUSED_BLOCK_START;
